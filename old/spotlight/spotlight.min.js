	...
	function Za()
		{
			...
			h(b,"touchend",kb);
			h(Pa,"click", function () {	Da?Da(z,D):Ca&&(location.href=Ca)} )
		}
}
...
function yb(a,b,c){
	b?ba(Ka,function(){yb(a,!1,c)}):g(Ka,"transform","translateX("+(100*-a+(c||0))+"%)")
}
...
function zb(a){
	if(L){
		...
		switch(a.keyCode){
			...
			case 37:fb();break;
			case 39:gb();break;
			case 38:case 107:case 187:b&&bb();break;
...
function sb(a)
{
	ua&&(ba(O,
		 ...
		 a&&(g(O,"transition-duration",Fa+"s"),
			 g(O,"transform","translateX(0)")
			)
		);
	a&&(R=setTimeout(gb,3E3*Fa))
}
...
function vb(a){
	if(a.g)a.g.appendChild(a),a.g=null;
		...
		var b=a.parentNode;b&&b.removeChild(a);a.src=a.onerror=""
	}
}
...
function Gb(a){
	...
	if(c=D.control){
		...
		or(var e=0;e<n.length;e++)D[n[e]]=!1;
